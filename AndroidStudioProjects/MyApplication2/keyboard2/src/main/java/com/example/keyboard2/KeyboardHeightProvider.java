...
public class KeyboardHeightProvider extends PopupWindow {
     ...
     */
    public void start() {
        Log.d("start","isShowing:"+isShowing()+","+parentView.getWindowToken());
        if (!isShowing() && parentView.getWindowToken() != null) {
            setBackgroundDrawable(new ColorDrawable(Color.YELLOW));
//            showAtLocation(parentView, Gravity.NO_GRAVITY, 500, 0);
//            EditText editText = (EditText) activity.findViewById(R.id.input_name);
            ToggleButton editText = (ToggleButton) activity.findViewById(R.id.show_hide);
...
//        }
    ...
    private void handleOnGlobalLayout() {
        ...
        Log.d("KeyboardHeightProvider","rect:"+rect+",screenSize:" +screenSize +",keyboardHeight:"+keyboardHeight);
